    ...
    <FooterContainer>
      <OptionsContainer>
        ...
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M3.69601 15.8112L2.15894 19.91C1.70676 21.1158 2.88429 22.2934 4.09012 21.8412L8.18896 20.3041C8.72361 20.1036 9.20914 19.791 9.6129 19.3872L10 19L5 14L4.6129 14.3872C4.20914 14.791 3.8965 15.2765 3.69601 15.8112Z" fill="var(--colors-gray10)"></path><path opacity="0.25" d="M5 14L10 19L19.5 9.5L14.5 4.5L5 14Z" fill="var(--colors-gray10)"></path><path d="M20.8787 8.12136L19.5 9.5L14.5 4.5L15.8787 3.12135C17.0503 1.94978 18.9497 1.94978 20.1213 3.12136L20.8787 3.87872C22.0503 5.05029 22.0503 6.94978 20.8787 8.12136Z" fill="var(--colors-gray10)"></path>
          ...
          <hr/>
          <NavLink exact to = "https://mobile.twitter.com/Techbro___" activeclassname="active">
        ...
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path opacity="0.25" d="M20.9999 7.5C21.4999 15 15.9999 21 8.99995 21C6.58804 21 4.17613 20.6768 2.28388 19.7706C1.85051 19.5631 2.0199 18.985 2.49936 18.9532C4.82944 18.7987 6.75765 18.2423 7.99995 17C11.0001 14 11.5 13 12.2646 9.02396C12.0933 8.54804 11.9999 8.03492 11.9999 7.5C11.9999 5.01472 14.0147 3 16.4999 3C18.0181 3 19.3607 3.75182 20.1757 4.90346L21.8929 4.65815C22.3207 4.59703 22.6194 5.07087 22.3796 5.43047L20.9999 7.5Z" fill="var(--colors-gray10)"></path><path d="M7.99998 16.9999C2.58358 15.1944 1.64928 8.49939 2.62226 5.00708C2.73651 4.59701 3.26964 4.59488 3.48453 4.96234C5.14601 7.80359 8.30518 9.38991 12.2646 9.02385C18.5 9.02385 17 19.9999 7.99998 16.9999Z" fill="var(--colors-gray10)"></path>
          ...
          <NavLink exact to ="https://github.com/Penuelnwaneri" activeclassname ="active">
        ...
        <NavLink exact to ="mailto:Penuelnwaneri@gmail.com" activeclassname ="active">
        <Tooltip label="Mail">
      <button>
