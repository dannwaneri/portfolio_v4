...
return (
    <FooterContainer>
      ...
      <motion.button
      whileHover={{scale:1}}
      whileTap={{y:-60,height:"48",width:"48", scale:0.8,transition:{type:'spring',delay:0.2,stiffness:260,damping:20}}}
      onClick={() =>{
      ...
      <motion.button
      whileHover={{scale:1}} 
      whileTap={{y:-60,height:"48",width:"48",transition:{ease:"easeInOut",type:'spring',delay:0.2,stiffness:260,damping:20}}}
      onClick={() => {
