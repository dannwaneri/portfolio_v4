...
return (
    <FooterContainer>
      ...
      <motion.button  
        ...
        whileTap={{y:-100,transition:{type:'spring',delay:0.15,stiffness:100}}}
      onClick={() => isClicked ? play():stop()}>
        ...
        <motion.button 
          ...
          whileTap={{y:-60,transition:{type:'spring',delay:0.15}}}
        onClick={() => isClicked ? play():stop()}>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      whileTap={{y:-50,transition:{type:'spring',delay:0.15}}}
      onClick={() => isClicked ? play():stop()}>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      whileTap={{y:-60,transition:{type:'spring',delay:0.2}}}
      onClick={() =>{
