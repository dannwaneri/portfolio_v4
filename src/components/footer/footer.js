...
const raysVariants = {
  initial:{opacity: 0,transition:"opacity 200ms ease 0ms",stroke:"var(--colors-gray11)",rotate: 0},
  animate:{opacity: 1,transition:"opacity 200ms ease 0ms",stroke:"var(--colors-gray11)", rotate: 40}
};

const coreVariants = {
  initial:{animation:"350ms ease 0s 1 normal none running",transformOrigin:"30% center"},
  animate:{animation:"0ms ease 0s 1 normal none running",transformOrigin:"30% center"}
};
...
<footer>
      ...
      onClick={() =>{
        ...
        <svg  width="48" height="48" viewBox="0 0 24 24" color="var(--colors-gray10)" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" stroke="currentColor">
          <circle className="sun" cx="12" cy="12" fill="var(--colors-gray10)" mask="url(#myMask2)" r="5"/>
          ...
          <mask className="moon" id="myMask2">
            <rect x="0" y="0" width="100%" height="100%" fill="white"></rect>
            <circle  r="7" fill="black" cx="100%" cy="0%"/>
          </mask>
      </svg>
      </button>
      <button
