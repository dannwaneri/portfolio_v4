...
const Home = () => (
    ...
    <LineContainer/>
    <TitleContainer>I care deeply about users, performance, accessibility, and having things be functional with  React,Node.js,Express.js,Graphql.</TitleContainer>
    </div>
)
